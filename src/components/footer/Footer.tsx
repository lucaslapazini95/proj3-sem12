    ...
    <footer className="border-t border-gray-400 p-4">
      <section className="flex flex-wrap justify-between items-start max-w-screen-xl mx-auto my-8 space-y-8 md:space-y-0">
        <div className="w-full md:w-1/4">
          <h2 className="text-xl mb-4 md:mb-10 text-left">Furniro.</h2>
          <p className="text-gray-600 text-left max-w-xs">
            400 University Drive Suite 200 Coral Gables, FL 33134 USA
          </p>
        </div>
        <div className="w-full md:w-1/4">
          <h3 className="font-medium text-gray-600 text-left mb-4 md:mb-12">
            Links
          </h3>
          <ul className="flex flex-col gap-2 md:gap-4 lg:gap-12">
            <li>
        ...
        <div className="w-full md:w-1/4">
          ...
          <div className="flex flex-col md:flex-row">
            <input
              ...
              className="border border-transparent border-b-black text-gray-600 text-sm py-2 outline-none transition-all focus:border-gray-600 focus:rounded-md hover:border-gray-600 hover:rounded-md w-full"
            />
